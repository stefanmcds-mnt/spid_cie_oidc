...
from pydantic import BaseModel, HttpUrl, constr, field_validator, validator

class TrustMarkRequest(BaseModel):
    trust_mark : Optional[constr(pattern=r"^[a-zA-Z\_\-0-9]+\.[a-zA-Z\_\-0-9]+\.[a-zA-Z\_\-0-9]+")] # type: ignore # noqa: F722
